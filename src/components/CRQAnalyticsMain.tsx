...
const SE_SUBDOMAIN_KPI: Record<string, [number, number, number, number, string]> = {
...
const CCB_SUBDOMAIN_KPI: Record<string, [number, number, number, number, string]> = {
...
const CRQAnalyticsMain: React.FC = () => {
  ...
  const kpiValues = useMemo(() => {
    ...
    const sub = filters.subDomain;
      ...
      row = [src[0].value, src[1].value, src[2].value, src[3].value, src[4].value as string];
    }
